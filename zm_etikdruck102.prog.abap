*---------------------------------------------------------------------*
* Report  ZM_ETIKDRUCK102                                           *
*---------------------------------------------------------------------*
*   Dätwyler AG                                                       *
*---------------------------------------------------------------------*
*                                                                     *
*    Programm-Name....: ZM_ETIKDRUCK102                             *
*    Entwickler.......: Peter Huber                                   *
*    Erstell-Datum....: 5.2010                                      *
*    Version..........: 1.0                                           *
...
*                                                                     *
*    Bemerkung........: Verwendung DRX MX
*                       Nur ein Behelf für die Produktivsetzung...... *
*    Aenderungen:                                                     *
...
*Tabellen                                                             *
*---------------------------------------------------------------------*
TABLES: makt, tsp03d, zmetik, lqua, mard, mch1.
...
select-options: s_lgnum for lqua-lgnum obligatory default '620',
...
*Clear
    clear:    ze101-etnr,  ze101-drnr,  ze101-anze,  ze101-wdatu,
              ...
              ze101-nlenr, ze101-vfdat, ze101-masch, ze101-vorga,
              ze101-eol .
...
*Etikettenlayout vorbelegen
    case: lqua-lgnum.
      when '600'. ze101-etnr  = 'DRXWMWE1'.
      when '620'. ze101-etnr  = 'DRXWMWE1'.
    endcase.
...
* Verfalldatum
    select single * from mch1 where matnr = lqua-matnr
                                and charg = lqua-charg.
    if sy-subrc = 0.
      concatenate mch1-vfdat+6(2) mch1-vfdat+4(2) mch1-vfdat+0(4)
      into ze101-vfdat separated by '.' IN       "smart: 2010-08-02 #101
...
*Vorgängscode bei DRX
    if lqua-lgnum = '600'.
      case: lqua-bestq.
        when 'Q'.  ze101-vorga = 'CA-PT'.
        when 'S'.  ze101-vorga = 'BL-PT'.
        when ' '.  ze101-vorga = 'PT'.
      endcase.
      clear: ze101-vfdat, ze101-aufnr, ze101-masch, ze101-nlenr.
    endif.
    ...
    if lqua-lgnum = '620'.
      ...
      when '001'.
      case: lqua-bestq.
        when 'Q'.  ze101-vorga = 'AL'.
        when ' '.  ze101-vorga = 'CA'.
        when 'S'.  ze101-vorga = 'AL'.
        clear: ze101-aufnr, ze101-masch.
      endcase.
      when '100'. ze101-vorga = 'JO'.
      ze101-aufnr = lqua-benum.
      endcase.
