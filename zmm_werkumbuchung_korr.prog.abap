...
select-options: slgnum for lqua-lgnum no intervals
                ...
                sbestq for lqua-bestq no intervals
                                      default 'R' obligatory,
...
perform bdc_field       using 'RM07M-WERKS' '3100'.
perform bdc_field       using 'RM07M-LGORT' '3920'.
...
perform bdc_field       using 'LTAP-WERKS' '3100'.
perform bdc_field       using 'LTAP-LGORT' '3920'.
