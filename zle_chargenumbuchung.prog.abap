...
*Bestand im 001
select single * from lqua where lgnum = lqua-lgnum
                            and lgtyp = '001'
*                            and lgpla = 'VORKOMMI'
...
perform bdc_field       using 'LTAP-NLTYP' '914'.
perform bdc_field       using 'LTAP-NLPLA' wlgpla.
